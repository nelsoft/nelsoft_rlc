    ...
    seltype.innerHTML = '<option value="1">Server</option><option value="2">POS-Server</option><option value="3">POS</option><option value="4">Office Computer</option><option value="5">POS (Cirms)</option>';
    ...
    var allow = '<?php echo $allowUuidEdit; ?>';
    if(allow == 1){
            ...
            if (isFirstLoad) {
                ...
                /*create_UUID().then(
                    function(value){
                        myjstbl.setvalue_to_rowindex_tdclass(
                            [value.toString()],
                            clientTerminalTable.rowCount,
                            colarray['colUuid'].td_class
                        );
                    }
                );*/
            }
	...
	function editSelectedRow( myTable, rowObj){
        ...
        var currentString = myTable.getvalue_by_rowindex_tdclass(
            rowindex,
        ...
        myTable.setvalue_to_rowindex_tdclass(
    ...
    async function create_UUID(){
        ...
        do{ // continue creating UUID until unique
        ...
        return await myPromise; // wait for result before return
    }
</script>
